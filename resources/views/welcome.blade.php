...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-N4Kk0OeY7o/kl1db+GF1bl6s/Wj4u14Jo2hC8+gR9zZzSVPp/H1g/hb9MKAPvphK" crossorigin="anonymous">
    </script>
                ...
                <div class="sticky-top">
                    ...
                    <ul class="nav flex-column" style="list-style-type: none; padding: 0;">
                        <li style="margin-bottom: 10px;">
                            <a href="#"
                                style="text-decoration: none; color: black; display: block;  padding: 10px; border-radius: 5px;"
                                class="fw-bold fs-1 py-4">Dashboard</a>
                        </li>
                        <li style="margin-bottom: 10px;">
                            <a href="/"
