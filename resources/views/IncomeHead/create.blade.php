...
<div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
        <form method="POST" action="{{ route('incomeHead.store') }}">
            @csrf
            <div style="margin-bottom: 20px;">
                <label for="income_category_id" style="display: block; margin-bottom: 5px;">Category Name:</label>
                <select id="income_category_id" name="income_category_id" class="form-control" style="width: 100%; padding: 8px;" required>
